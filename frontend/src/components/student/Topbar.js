...
export default function Topbar({ title, subtitle }) {
  ...
  return (
    <header style={{ height: 62, background: 'var(--surface)', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', padding: '0 30px', gap: 14, position: 'sticky', top: 0, zIndex: 50 }}>
      ...
      <div style={{ background: 'rgba(79,142,247,.1)', border: '1px solid rgba(79,142,247,.25)', color: 'var(--accent)', fontSize: 12, fontWeight: 500, padding: '6px 14px', borderRadius: 20 }}>Semester 6 · Even Sem</div>
